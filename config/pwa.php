...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | When set to false, the service worker generated by pwa:generate will
    | immediately unregister itself and clear all caches. This lets you
    | safely disable the PWA in local or staging environments without
    | touching any Blade templates.
    |
    */
